 ...
 */
final class Version20220820145422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location ADD city_id INT NOT NULL, DROP city');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location ADD city VARCHAR(255) DEFAULT NULL, DROP city_id');
    }
}
