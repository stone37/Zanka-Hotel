...
class SettingsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('numberHostelPerPage', IntegerType::class, ['label' => 'Nombre d\'établissement par page (facultatif)', 'required' => false])
            ->add('numberRoomPerPage', IntegerType::class, ['label' => 'Nombre d\'hébergement par page (facultatif)', 'required' => false])
            ->add('numberUserHostelFavoritePerPage', IntegerType::class, ['label' => 'Nombre d\'établissement en favoris par page (facultatif)', 'required' => false]);
    }
