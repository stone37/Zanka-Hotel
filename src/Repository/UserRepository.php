...
class UserRepository extends AbstractRepository implements PasswordUpgraderInterface
{
    ...
    public function getAdminPartners(UserSearch $search): ?QueryBuilder
    {
        $qb = $this->createQueryBuilder('u')
            ->leftJoin('u.hostels', 'hostels')
            ->addSelect('hostels')
            ->where('u.deleteAt IS NULL')
            ->andWhere('u.confirmationToken IS NULL')
            ->andWhere('u.roles LIKE :roles')
    ...
    public function getPartnerNoConfirmed(UserSearch $search): ?QueryBuilder
    {
        $qb = $this->createQueryBuilder('u')
            ->where('u.deleteAt IS NULL')
            ->andWhere('u.confirmationToken IS NOT NULL')
    ...
    public function getPartnerDeleted(UserSearch $search): ?QueryBuilder
    {
        $qb = $this->createQueryBuilder('u')
            ->where('u.deleteAt IS NOT NULL')
            ->andWhere('u.confirmationToken IS NULL')
