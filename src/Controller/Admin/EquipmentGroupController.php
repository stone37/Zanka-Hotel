...
class EquipmentGroupController extends AbstractController
{
    ...
    #[Route(path: '/equipments-group', name: 'app_admin_equipment_group_index')]
    ...
    #[Route(path: '/equipments-group/create', name: 'app_admin_equipment_group_create')]
    ...
    #[Route(path: '/equipments-group/{id}/edit', name: 'app_admin_equipment_group_edit', requirements: ['id' => '\d+'])]
    ...
    #[Route(path: '/equipments-group/{id}/move', name: 'app_admin_equipment_group_move', requirements: ['id' => '\d+'])]
    public function move(Request $request, EquipmentGroup $equipmentGroup)
    {
    ...
    #[Route(path: '/equipments-group/{id}/delete', name: 'app_admin_equipment_group_delete', requirements: ['id' => '\d+'], options: ['expose' => true])]
    ...
    #[Route(path: '/equipments-group/bulk/delete', name: 'app_admin_equipment_group_bulk_delete', options: ['expose' => true])]
