...
class ExchangeRateController extends AbstractController
{
    ...
    public function edit(Request $request, ExchangeRate $exchange)
    {
        $form = $this->createForm(ExchangeRateType::class, $exchange);
    ...
    public function delete(Request $request, ExchangeRate $exchange)
    {
    ...
    private function deleteForm(ExchangeRate $exchange)
    {
