...
class AccountDeletionController extends AbstractController
{
    ...
    #[Route(path: '/profil/delete', name: 'app_partner_delete')]
    public function delete(Request $request): Response
    {
        ...
        return $this->render('partner/account/delete.html.twig', [
            'user' => $user,
    ...
    #[Route(path: '/profil/delete', name: 'app_user_partner_ajax', options: ['expose' => true])]
    ...
    #[Route(path: '/profil/cancel-delete', name: 'app_partner_cancel_delete', methods: ['POST'])]
    ...
    private function deleteForm(): FormInterface
    {
        return $this->createFormBuilder([])
            ->setAction($this->generateUrl('app_partner_delete'))
            ->setMethod('POST')
